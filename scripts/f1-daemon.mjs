...
const DAEMONS = [
  ...
  {
    label: "run.factory.honker-relay",
    plist: `${HOME}/Library/LaunchAgents/run.factory.honker-relay.plist`,
    process_signature: "honker_relay.py",
    required: true,
  },
  {
    label: "run.factory.sasha-skeptic",
    plist: `${HOME}/Library/LaunchAgents/run.factory.sasha-skeptic.plist`,
    process_signature: "sasha-skeptic.mjs",
    required: true,
  },
  {
    label: "run.factory.blake-budget-marshal",
    plist: `${HOME}/Library/LaunchAgents/run.factory.blake-budget-marshal.plist`,
    process_signature: "blake-budget-marshal.mjs",
    required: true,
  },
  {
    label: "run.factory.phoenix-todo-keeper",
    plist: `${HOME}/Library/LaunchAgents/run.factory.phoenix-todo-keeper.plist`,
    process_signature: "phoenix-todo-keeper.mjs",
    required: true,
  },
  {
    label: "run.factory.rotate-logs",
    plist: `${HOME}/Library/LaunchAgents/run.factory.rotate-logs.plist`,
    process_signature: "factory-rotate-logs.mjs",
    required: false,
  },
  {
    label: "run.factory.alert",
    plist: `${HOME}/Library/LaunchAgents/run.factory.alert.plist`,
    process_signature: "factory-alert.mjs",
    required: false,
  },
];
