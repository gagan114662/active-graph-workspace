...
| Auditable and verifiable | committed or tracked logs/status/eval with literal command/API output | frame artifacts exist; bridge gauntlet and launchd proof logs capture message ids, trigger ids, ACK ids, timings, commands, and launchctl readback | green |
